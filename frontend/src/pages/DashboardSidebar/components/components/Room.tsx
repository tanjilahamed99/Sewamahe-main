...
export default function Room({ room }) {
  ...
  const getStatus = () => {
    ...
    if (onlineUsers.some((u) => u.id === other._id && u.status === "busy"))
      return "busy";
    if (onlineUsers.some((u) => u.id === other._id && u.status === "online"))
      return "online";
    ...
    <Card
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <div className="truncate max-w-[180px]">
            {/* {other.type === "Consultant" && <p>{other.qualification}</p>} */}
      ...
      <div className="flex items-center">
        ...
        <div
          ...
          <DropdownMenu open={hover} onOpenChange={() => setHover(!hover)}>
            <DropdownMenuTrigger asChild>
              <Button size="icon" variant="ghost">
                <FiMoreHorizontal className="h-4 w-4 " />
              </Button>
            </DropdownMenuTrigger>
            <DropdownMenuContent align="end" className=" hover:bg-slate-50">
