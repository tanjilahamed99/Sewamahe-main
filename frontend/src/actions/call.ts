...
export const Calling = async ({
    ...
    if (user?.type === "user" && other.consultantStatus === "Pending" && other.type === "Consultant")
        return toast.warning("Consultant is unverified. You can't make call to unverified consultant.");
